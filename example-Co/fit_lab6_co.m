function [] = fit_lab6_co
% fit_lab6

% set global wavelength
global Lambda WAVELENGTHS
Lambda = 1.79019; % Kalpha
WAVELENGTHS = [1.0000, (1.788890-Lambda)/Lambda;
               0.5000, (1.792801-Lambda)/Lambda];
         
% read data
td = read('LaB6-CoKa.xy', 'xy');
...
tt = readtable('lab6_co_pcd_hkl.csv', 'HeaderLines',1);
